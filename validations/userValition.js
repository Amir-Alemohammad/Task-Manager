...
const fullnameRegex = /[آ-ی]/

const userValidation = Yup.object().shape({
    FullName: Yup.string().matches(fullnameRegex,"نام و نام خانواگی را به فارسی وارد کنید").required("نام و نام خانوادگی الزامی می باشد").min(3,"نام و نام خانوادگی نباید کمتر از 3 کاراکتر باشد"),
